...
bool vecMeta::createVecTable(VectorMeta& vec, TableMeta& table){
    ...
    vec.metadataSize = sizeof(int32_t) + tns + sizeof(int32_t) + sizeof(uint32_t) + sizeof(int32_t); //metadataSize, name, pkSize, recordCount, payloadSize 
